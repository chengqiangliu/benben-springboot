...
public class NotepadController {
    ...
    @RequestMapping(value = ApiRequestMapping.NOTEPAD_ADD_REQUEST_MAPPING, method = RequestMethod.POST,
    ...
    public ResponseEntity<BenbenResponse> addNotepad(UserRequest request) {
    ...
    @RequestMapping(value = ApiRequestMapping.NOTEPAD_DELETE_REQUEST_MAPPING, method = RequestMethod.POST,
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE + BenbenConstants.PRODUCE_CHARSET)
    @ResponseBody
    @BenbenApiEndpoint(apiName = ApiName.REGISTER_USER)
    public ResponseEntity<BenbenResponse> deleteNotepad(UserRequest request) {
    ...
    @RequestMapping(value = ApiRequestMapping.NOTEPAD_UPDATE_REQUEST_MAPPING, method = RequestMethod.POST,
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE + BenbenConstants.PRODUCE_CHARSET)
    @ResponseBody
    @BenbenApiEndpoint(apiName = ApiName.REGISTER_USER)
    public ResponseEntity<BenbenResponse> udpateNotepad(UserRequest request) {
    ...
    @RequestMapping(value = ApiRequestMapping.NOTEPAD_LIST_REQUEST_MAPPING, method = RequestMethod.GET,
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE + BenbenConstants.PRODUCE_CHARSET)
    @ResponseBody
    @BenbenApiEndpoint(apiName = ApiName.REGISTER_USER)
    public ResponseEntity<BenbenResponse> listNotepad(UserRequest request) {
