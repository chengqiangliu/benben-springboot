...
public class DepositController {
    ...
    @RequestMapping(value = ApiRequestMapping.DEPOSIT_ADD_REQUEST_MAPPING, method = RequestMethod.POST,
    ...
    public ResponseEntity<BenbenResponse> addDeposit(UserRequest request) {
    ...
    @RequestMapping(value = ApiRequestMapping.DEPOSIT_DELETE_REQUEST_MAPPING, method = RequestMethod.POST,
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE + BenbenConstants.PRODUCE_CHARSET)
    @ResponseBody
    @BenbenApiEndpoint(apiName = ApiName.REGISTER_USER)
    public ResponseEntity<BenbenResponse> deleteDeposit(UserRequest request) {
    ...
    @RequestMapping(value = ApiRequestMapping.DEPOSIT_UPDATE_REQUEST_MAPPING, method = RequestMethod.POST,
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE + BenbenConstants.PRODUCE_CHARSET)
    @ResponseBody
    @BenbenApiEndpoint(apiName = ApiName.REGISTER_USER)
    public ResponseEntity<BenbenResponse> udpateDeposit(UserRequest request) {
    ...
    @RequestMapping(value = ApiRequestMapping.DEPOSIT_LIST_REQUEST_MAPPING, method = RequestMethod.GET,
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE + BenbenConstants.PRODUCE_CHARSET)
    @ResponseBody
    @BenbenApiEndpoint(apiName = ApiName.REGISTER_USER)
    public ResponseEntity<BenbenResponse> listDeposit(UserRequest request) {
